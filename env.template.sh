...
#ETHERPAD_URL_BASE=http://etherpad.party.jitsi:9001
...
XMPP_DOMAIN=party.jitsi

# Internal XMPP server
XMPP_SERVER=xmpp.party.jitsi

# Internal XMPP server URL
XMPP_BOSH_URL_BASE=http://xmpp.party.jitsi:5280

# Internal XMPP domain for authenticated services
XMPP_AUTH_DOMAIN=auth.party.jitsi

# XMPP domain for the MUC
XMPP_MUC_DOMAIN=muc.party.jitsi

# XMPP domain for the internal MUC used for jibri, jigasi and jvb pools
XMPP_INTERNAL_MUC_DOMAIN=internal-muc.party.jitsi

# XMPP domain for unauthenticated users
XMPP_GUEST_DOMAIN=guest.party.jitsi
...
XMPP_RECORDER_DOMAIN=recorder.party.jitsi
